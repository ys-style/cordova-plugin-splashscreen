...
- (void)pluginInitialize
{
    ...
    setting  = @"LoaderHeightRatio";
    if ([self settingForKey:setting]) {
        _heightRatio = [(NSNumber*)[self settingForKey:setting] intValue];
    }
...
- (void)createViews
{
    ...
    _activityView.center = CGPointMake(parentView.bounds.size.width / 2, (parentView.bounds.size.height / 100) * _heightRatio);
